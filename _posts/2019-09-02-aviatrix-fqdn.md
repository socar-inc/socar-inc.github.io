...
설치 방법은 두가지를 제공합니다.
![1](/img/posts_aviatrix/cloudformation-image.png){: width="720" height="400"}{: .center}{: .center}
...
![2](/img/posts_aviatrix/cloudformation-output.png){: width="720" height="400"}{: .center}{: .center}
...
![3](/img/posts_aviatrix/aviatrix-1.png){: width="720" height="400"}{: .center}{: .center}
...
![10](/img/posts_aviatrix/aviatrix-gw-add.png){: width="720" height="400"}{: .center}{: .center}
...
![11](/img/posts_aviatrix/route-table-avi.png){: width="720" height="400"}{: .center}{: .center}
...
![12](/img/posts_aviatrix/fqdn-list.png){: width="720" height="400"}{: .center}{: .center}
```bash
...
![13](/img/posts_aviatrix/fqdn-architecture.png){: width="720" height="800"}{: .center}{: .center}
            ...
            "Properties": {
                ...
                "PolicyDocument": {
                    ...
                    "Statement": [{
                            ...
                            "Action": [..........................
```
![4](/img/posts_aviatrix/role-check.png){: width="720" height="400"}{: .center}{: .center}

CloudFormation Template으 로 구성된 `AWS 인프라의 이미지`를 통해 정리할 경우 아래와 같은 구성이 설정 됩니다.

1. Aviatrix Controller Instance 에 role-ec2 설정

![5](/img/posts_aviatrix/role-ec2.png){: width="720" height="300"}{: .center}{: .center}
...
```
![6](/img/posts_aviatrix/role-ec2-policy.png){: width="720" height="300"}{: .center}{: .center}
...
![7](/img/posts_aviatrix/role-app-trust.png){: width="720" height="300"}{: .center}{: .center}

#### **`Multiple AWS Accounts with Role Switchin Aviatrix Architecture`**

![8](/img/posts_aviatrix/role-ec2-app-muac.png){: width="720" height="400"}{: .center}{: .center}
