...
이번 글은 '빠르고 정확하게, 신사업 FMS 데이터 파이프라인 구축기'의 2편으로 신뢰성있는 데이터를 제공하기 위한 노력들을 다룹니다. 사용자에게 신뢰성 있는 데이터를 제공하기 위해선 파이프라인의 고가용성이 보장되어야 하며 데이터의 품질도 일정 수준 이상 보장되어야 합니다.
...
## 1. 견고한 파이프라인을 위한 E2E 테스트 환경 구축하기
