...
- [2. 아이콘 컴포넌트, 어떻게 만들어졌을까?](#2.-아이콘-컴포넌트,-어떻게-만들어졌을까?)
  ...
  - [2.4 색상도 타입으로 정의해보자](#2.4-색상도-타입으로-정의해보자)
  - [2.5 스크립트 실행을 자동화해보자](#2.5-스크립트-실행을-자동화해보자)
  - [2.6 스토리북에 적용해서 확인해보자](#2.6-스토리북에-적용해서-확인해보자)
- [3. 무엇이 달라졌을까?](#3.-무엇이-달라졌을까?)
  - [3.2 문제점이 해결되었는지 알아보자](#3.2-문제점이-해결되었는지-알아보자)
- [4. 더 개선할 부분이 있을까?](#4.-더-개선할-부분이-있을까?)
- [5. 마무리해볼까?](#5.-마무리해볼끼?)
...
### 3.2 문제점이 해결되었는지 알아보자 <a name="3.2-문제점이-해결되었는지-알아보자" />
...
## 4. 더 개선할 부분이 있을까? <a name="4.-더-개선할-부분이-있을까?" />
