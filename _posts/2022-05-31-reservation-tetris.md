...
[지표 정의 : 어떤 상태가 더 '최적'일까?]()에서 설명드린 차량 사용 비율과 가동률 지표를 토대로 데이터를 파악했습니다

일별 차량 사용 비율 대비 가동률을 적용 전후로 확인해보면 다음과 같습니다.
...
특히 팬데믹 이후 여행 수요가 몰려 성수기 수준으로 예약이 밀려들어오는 상황인 제주사업팀에서 예약 테트리스가 큰 도움이 되고 있다는 소식을 들었을 때 굉장히 뿌듯했습니다 :)
