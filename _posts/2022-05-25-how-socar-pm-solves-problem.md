...
차량 예약 데이터를 확인했을 때, 부름 사용자는 왕복과 **나이, 대여시간에 차이**를 보인다는 점을 발견했습니다. (일정 기간 동안의 평균치)

![segment-1](/img/how-socar-pm-solves-problem/segment-1.png)
![segment-2](/img/how-socar-pm-solves-problem/segment-2.png)

* “부름 사용자의 3~40대 비중이 약 **`10%`** 가량 더 높다”
...
* 그 분들은 **이 상황에서는 명확하게 부름을 쓰러 앱에 들어오며, 쏘카존까지 걸어가지 않아도 되는 부름 서비스의 장점을 느꼈다**는 이야기를 자세히 들을 수 있었습니다.
...
다음으로, 시도할 **가설을 설정했어요.** 지금처럼 왕복과 똑같은 플로우가 아닌 **[부름 사용자] 관점에서 설계한 부름전용 예약 Flow 를 제공한다면,** 결제전환율의 차이와 기분 좋은 예약 경험 두 가지를 확인할 수 있을 것이라는 가설입니다.
...
치열했던 개발 기간이 흐르고..  드디어 실험이 담긴 버전을 출시!!! 🚀🚀🚀 몇 주간 두근두근 하며 사용자들의 반응을 모니터링 했습니 .
