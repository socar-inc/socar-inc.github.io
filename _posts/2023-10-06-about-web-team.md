...
쏘카의 웹 팀에 대해 알려진 게 별로 없어 웹 팀의 문화와 분위기를 보여줄 수 있는 글을 작성했습니다. 글 작성에 도움 주시고 피드백도 많이 남겨주신 람다와 비에타 그리고 웹 팀, 크로스셀링 팀 팀원 분들께 감사드립니다. 더 궁금한 내용이 있으시면 댓글 남겨주시면 감사하겠습니다. 쏘카의 웹 팀에 합류하고 싶으신 분은 채용 공고 페이지를 확인해주세요!