...
현재 DL 모델의 학습은 별도의 시스템에서 이루어지고, 이후 학습이 완료된 모델을 적용하는 단계부터의 서빙 시스템이 구축된 상태입니다. 향후에는 모델의 성능을 운영과정 중에 모니터링 하면서, 신규 차량 이미지들을 학습에 적용하여 모델의 성능을 지속적으로 개선할 수 있는 시스템으로 조금씩 확장해 보고자 합니다.<br><br>
