...
쏘카 프론트엔드 모노레포는 [Turborepo](https://turbo.build/repo) 기반으로 모노레포 환경을 구성했습니다. 멀티레포와 다르게 하나의 Repository로 프로젝트들을 관리하게 되면서 새로운 스캐폴딩 방식 중 하나인 `Code Generator`를 도입하게 되었습니다.
