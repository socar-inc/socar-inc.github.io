...
누락된 정보는 사용자가 어떤 기종을 사용하고 있는지, 앱의 버전 정보였습니다. 이 정보는 `웹의 쿠키에 저장된 값`으로, 앱이 웹뷰를 띄울 때 사용자 정보를 전달하고 웹은 그 정보를 쿠키에 저장한 후 서버 요청 시 활용하고 있었습니다.
...
<p style='text-align: center; color: #646f7c;'>포그라운드 -> 웹뷰 리프레시 -> 쿠기 유지 -> 서버 호출 시 정상적으로 동작</p>
